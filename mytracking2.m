...
%while ~isDone(obj.reader)
  ...
  for k = 1: totalframenum % Loop through every frame in the video
     ...
     %frame = imresize(frame,2);%Enlarge the frame
    if (k < 1)
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.detector = vision.ForegroundDetector('NumGaussians', 3, ...
            'NumTrainingFrames', 30, 'MinimumBackgroundRatio', 0.9,'LearningRate',0.0001); %default is 3, 105, 0.7, 0.0005
        ...
        obj.blobAnalyser = vision.BlobAnalysis('BoundingBoxOutputPort', true, ...
            'AreaOutputPort', true, 'CentroidOutputPort', true, 'LabelMatrixOutputPort', true , 'MinimumBlobArea', 20, 'ExtentOutputPort',true ,'MaximumCount', 1, ...
